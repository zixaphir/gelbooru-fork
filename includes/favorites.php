<?php
	...
	else if(isset($_GET['s']) && $_GET['s'] == "list")
	{
		...
		$misc = new misc();
		print $misc->pagination($_GET['page'],$_GET['s'],$eh,$limit,$page_limit,$numrows,$_GET['pid']);
	}
